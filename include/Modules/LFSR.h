#ifndef STOCHASTIC_COMPUTING_LFSR_H
#define STOCHASTIC_COMPUTING_LFSR_H
...
public:
  ...
  public:
    ...
    bool inserting_zero;
    int zero_position;
    setting(bitstream_list seed, bitstream_list poly, bitstream_list scram = {},
            bitstream_list inverter = {}, bool inserting_zero = true,
            int zero_position = 0) {
    ...
    friend bool operator==(const setting &a, const setting &b) {
      return a.seed == b.seed && a.polynomial == b.polynomial &&
             a.scrambling == b.scrambling && a.inverter == b.inverter &&
             a.inserting_zero == b.inserting_zero &&
             a.zero_position == b.zero_position;
    }
  };
  int N;
  bitstream_list LFSR_inverter;

  explicit LFSR_(int N_, bitstream_list LFSR_inverter_ = {});

  bitstream_list simulate(const setting &set) const;
  std::vector<bitstream_list> search_polynomials();
} LFSR;

#endif // STOCHASTIC_COMPUTING_LFSR_H
